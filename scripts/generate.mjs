...
await writePage("/types-of-chopsticks/", pageLayout({
  ...
  body: `
    ...
    <section class="content-section article-body">
      ...
      <p>The next question is not just 鈥渨hich type is best?鈥?It is 鈥渂est for what use case?鈥?Learning, gifting, restaurant style, and daily home use lead to different answers.</p>
    </section>
    <section class="content-section">
      <div class="section-heading">
...
await writePage("/chopstick-etiquette/", pageLayout({
  ...
  body: `
    ...
    <section class="content-section article-body">
      ...
      <p>That is why simple table habits matter more than trying to perform 鈥減erfect鈥?etiquette from memory.</p>
    </section>
...
await writePage("/best-chopsticks-for-beginners/", pageLayout({
  ...
  body: `
    ...
    <section class="content-section article-body">
      ...
      <p>The real goal is not 鈥渢he fanciest set.鈥?It is the set that makes the first week of practice easier.</p>
    </section>
    ${comparisonTable(chopstickTypes)}
    ${faqBlock(standardFaqs())}
  `
...
body:not(.page-home):not(.page-guides):not(.seo-report-page) .article-main>.content-section{width:100%;max-width:none!important;margin:0!important;padding:28px 32px!important;border-radius:10px;background:rgba(255,253,247,.96)!important;border:1px solid rgba(184,170,119,.5)!important;box-shadow:0 16px 38px rgba(105,82,43,.08)!important}
...
@media(max-width:980px){.product-category-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.best-pick-grid{grid-template-columns:1fr}.best-pick-card{grid-template-columns:auto minmax(0,1fr)}.best-pick-card .button-link{grid-column:2;justify-self:start}}
@media(max-width:640px){.hero-product-links{display:grid}.product-category-grid{grid-template-columns:1fr}.best-pick-card{grid-template-columns:1fr}.best-pick-card .button-link{grid-column:auto}.pick-rank{width:40px;height:40px}body:not(.page-home):not(.page-guides):not(.seo-report-page) .article-main>.content-section{padding:20px!important}body:not(.page-home):not(.page-guides):not(.seo-report-page) .article-shell{gap:22px}}
