...
.page-guides .article-search{grid-template-columns:minmax(420px,1.1fr) minmax(420px,.9fr);gap:42px;align-items:center!important;padding:28px clamp(28px,4.4vw,56px)!important}
